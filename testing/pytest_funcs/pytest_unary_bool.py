...
import pytest
from test_cases.test_unary_bool import test_is_empty, test_is_empty_dec, test_is_entire, test_is_entire_dec, test_is_common, test_is_common_dec, test_is_singleton, test_is_singleton_dec
